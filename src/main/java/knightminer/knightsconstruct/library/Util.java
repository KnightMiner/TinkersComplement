...
public class Util {
	public static String resource(String name) {
		return String.format("%s:%s", KnightsConstruct.modID, name.toLowerCase(Locale.US));
	}
	...
	public static ResourceLocation getResource(String res) {
		return new ResourceLocation(KnightsConstruct.modID, res);
	}
	...
	public static Logger getLogger(String type) {
		String log = KnightsConstruct.modID;
