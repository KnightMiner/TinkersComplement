package knightminer.knightsconstruct.feature.blocks;
...
public class BlockMelter extends BlockMultiblockController {
	...
	public BlockMelter(BlockTank melterTank) {
		super(Material.ROCK);
		this.setCreativeTab(KnightsRegistry.tabGeneral);
		this.setHardness(3F);
	...
	protected boolean openGui(EntityPlayer player, World world, BlockPos pos) {
		...
		player.openGui(KnightsConstruct.instance, 0, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
