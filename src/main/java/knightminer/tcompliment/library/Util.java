...
public class Util {
	public static String resource(String name) {
		return String.format("%s:%s", TinkersCompliment.modID, name.toLowerCase(Locale.US));
	}
	...
	public static ResourceLocation getResource(String res) {
		return new ResourceLocation(TinkersCompliment.modID, res);
	}
	...
	public static Logger getLogger(String type) {
		String log = TinkersCompliment.modID;
